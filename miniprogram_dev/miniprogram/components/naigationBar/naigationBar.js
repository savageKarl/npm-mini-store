  ...
  lifetimes: {
    attached: function attached() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var systemInfo, capsuleInfo, navAreaHeight, statusBarHeight, navHeight, navAreaStyle, statusBarStyle, navBarStyle, navAreaMiddleStyle;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                navAreaHeight = capsuleInfo.bottom + capsuleInfo.top - systemInfo.statusBarHeight * 2;
                statusBarHeight = systemInfo.statusBarHeight;
                navHeight = navAreaHeight + statusBarHeight;
                navAreaStyle = {
                ...
                navBarStyle = {
                  background: _this.properties.navBarBackground,
                  color: _this.properties.navBarTextColor
                };
                navAreaMiddleStyle = {
                  "text-align": _this.properties.navTitleAlign
                };
                if (!_this.properties.isShowBackArea && _this.properties.navTitleFillBackArea) {
